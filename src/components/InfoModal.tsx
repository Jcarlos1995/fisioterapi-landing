  ...
  <div className="space-y-8 text-slate-600 text-sm leading-relaxed">
    ...
    <section className="bg-slate-800 rounded-2xl p-6 text-white flex flex-col gap-3">
      ...
      <a
        ...
        className="flex items-center gap-3 text-slate-300 text-xs hover:text-green-400 transition-colors"
      >
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-2xl p-5 flex flex-col gap-2">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold text-sm px-4 py-2 rounded-full transition-all active:scale-95 shadow-sm"
          >
